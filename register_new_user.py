...
class RegisterNewUser(unittest.TestCase):
    ...
    def test_new_user(self):
        ...
        middle_name.send_keys('Kevin')
        driver.implicitly_wait(1)
        last_name.send_keys('Kevin')
        driver.implicitly_wait(1)
        email_address.send_keys('Kevin@test.com')
        driver.implicitly_wait(1)
        news_letter_subs.send_keys('Kevin')
        driver.implicitly_wait(1)
        password.send_keys('Kevin')
        driver.implicitly_wait(1)
        confirm_password.send_keys('Kevin')
        driver.implicitly_wait(1)
        submit_button.click()
